# Post A Job / Request Help Strategy
...
Avoid a public job board until there are enough active contractors to create reliable responses.

Risks of launching public posts too early:

- Residents post requests and hear nothing back.
- Contractors see stale or irrelevant jobs.
- The site starts to feel empty even if the directory itself is useful.

The launch goal is confidence: residents should feel BuiltLocal helps them find someone real, not that it adds another place where requests disappear.
...
- Keep the prototype focused on directory search, profiles, claim flow, and reviews.
- Mention job requests only in strategy and Pro dashboard lead placeholders.
- During business outreach, ask whether providers would want matched local leads and what categories/towns they serve.
- Use those answers to decide whether the first paid Pro feature is profile promotion, review collection, or lead routing.
